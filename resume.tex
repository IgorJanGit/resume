...
%-----------SUMMARY-----------
\section{Summary}
Computer Science student specializing in energy systems software, data analytics, and building–grid integration. Experienced with Eclipse VOLTTRON, BACnet tooling, and modern event-driven architectures. Motivated to contribute to EEIP projects in electricity infrastructure, building system analytics, and control while collaborating with multidisciplinary research teams.
%-----------SKILLS-----------
...
\small{
  \item{
    	...
    	extbf{Cloud \& Systems}: AWS, Docker, Event-Driven Architecture \\
    	extbf{Tooling}: Git, GitHub Actions, Node.js, PydanticAI \\
    	extbf{Databases}: MySQL, MongoDB \\
    	extbf{Energy \& Buildings}: Eclipse VOLTTRON, BACnet (scanner), building systems (project experience) \\
    	extbf{Core Concepts}: OOP, Data Structures, Algorithms, Full-Stack Development
  }
}
\end{itemize}
...
\resumeSubHeadingListStart
    \resumeProjectHeading
      {\textbf{Eclipse VOLTTRON} $|$ \emph{Python, BACnet, PydanticAI, CLI Tools}}{}
      \resumeItemListStart
        \resumeItem{Contributed to Eclipse VOLTTRON, an open-source, agent-based platform for distributed energy and building systems at PNNL.}
        \resumeItem{Developed a BACnet scanner to improve device discovery and system observability.}
        \resumeItem{Built an AI-driven CLI interpreter to simplify command-line interaction and improve developer usability.}
        \resumeItem{Worked in a research-driven, modular architecture on a large-scale open-source codebase.}
    \resumeItemListEnd
